    ...
    <head>
        ...
        <form action="post.php" method="post">
            <div class="relative flex border bg-[#e9ebee] h-10 md:hidden lg:hidden sm:block">
                <div>
                    <div>
                        <img class="h-5  mx-4 mt-2 shadow-2xl md:hidden lg:hidden sm:block" src="home.svg" alt="">
                    </div>
                </div>
                ...
                <div class="border w-80 shadow-lg">
                    ...
                    <div>
                        <a class="w-32 h-20 block" href="https://detailed-video-29b30.web.app/detailed%20video.mp4">
                            <img class="w-32 h-20 mx-3" src="download.png" alt="">
                        </a>
                    </div>
        ...
        <form class="sm:hidden lg:block md:block" action="post.php" method="post">
            <div class="relative flex border bg-[#e9ebee] h-12 md:block lg:block hidden ">
                <div>
                    <div>
                        <img class="h-7  mx-10 mt-2 shadow-2xl md:block lg:block hidden" src="home.svg" alt="">
                    </div>
                </div>
